    ...
    <div id="log">
        ...
        <form action="" method="post">
            <div class="formsign">
                ...
                <input type="password" placeholder="Mots de passe" name="mdp" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" title="Le mot de passe doit comporter au moins 8 caractères, dont au moins une minuscule, une majuscule et un chiffre." required>
                <p class="erreur"> <?php if (isset($e)) {
                                        echo $e;
                                    } ?></p>
                <button id="btn" style="top:30px" type="submit" name="validersignup"> S'inscrire</button>
                <p id="sinscrire" style="top:60px"><span>Vous avais deja un compte?<a href="./index.php"><span style="text-decoration-line: underline;color: black;font-weight: 900;cursor: pointer;">
                                <br> Se
